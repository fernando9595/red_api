 <?php
    //http://localhost/red_api/index.php?idJob=_rpt_auditores_resumen_total&desde=2022-05-01&hasta=2022-06-01&token=123
    ...
    kst("SELECT U.usuario,count(P.fecha) as cantidad");
