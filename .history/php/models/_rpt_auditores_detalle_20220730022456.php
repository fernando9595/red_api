 <?php
    //http://localhost/red_api/index.php?idJob=_rpt_auditores_resumen&desde=2022-05-01&hasta=2022-06-01&token=123
    ...
    kst("SELECT substr(P.f_auditado,1,10) as fecha,U.usuario,count(P.fecha) as cantidad");
