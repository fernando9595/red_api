 <?php
   ...
   for ($i = 0; $i < count($arr); $i++) {
      ...
      echo "<tr>";
      echo "<td style='border :1px solid grey; border-collapse: collapse;'>$fecha</td>";
      echo "<td style='border :1px solid grey; border-collapse: collapse;'>$periodo-$idDelegacion</td> ";
      echo "<td style='border :1px solid grey; border-collapse: collapse;'>$c_bariloche</td>";
      echo "<td style='border :1px solid grey; border-collapse: collapse;'>$c_bolson</td> ";
      echo "<td style='border :1px solid grey; border-collapse: collapse;'>$c_v_agostura</td>";
      echo "<td style='border :1px solid grey; border-collapse: collapse;'>$c_san_martin</td>";
      echo "</tr>";
      flush();
      ob_flush();
   }
